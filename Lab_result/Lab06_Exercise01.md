...
- เข้าถึงproperty name ของ class person ผ่านชื่อคลาสตรงๆ และ GetName() จะคืนค่าข้อความที่แสดดงค่าของ Property nameด้วยข้อความ Hello from ต่อด้วยproperty name
